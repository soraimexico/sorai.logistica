...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel de administración | Sistema de Logistica</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Sistema de Logistica">
    <meta name="author" content="logistica - Sistemas sorai" />
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          <img style="margin-top:-15px;margin-right:5px" src="assets/img/pre.gif" idth="96" height="60"alt="Logo"> 
          <span style="font-size:20px">Logistica</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="http://sorai.tk/" target="_blank">sorai Mexico</a>.</strong>
      </footer>
    </div><!-- ./wrapper -->
