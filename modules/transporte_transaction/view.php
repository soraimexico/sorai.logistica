...
<section class="content-header">
  <h1>
    ...
    <a class="btn btn-primary btn-social pull-right" href="?module=form_transporte_transaction&form=add" title="Agregar" data-toggle="tooltip">
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.tipo_transaccion, a.codigo_transaccion,a.fecha,a.codigo,a.destino,a.numero,b.codigo,b.nombre,b.unidad
                                            FROM transaccion_transporte as a INNER JOIN transporte as b ON a.codigo=b.codigo ORDER BY codigo_transaccion DESC")
