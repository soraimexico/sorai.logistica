...
<script type="text/javascript">
  function tampil_obat(input){
    ...
    $.post("modules/transporte_transaction/transporte.php", {
      dataidobat: num,
    }, function(response) {      
      $('#stok').html(response)
...
<section class="content-header">
  <h1>
    <i class="fa fa-edit icon-title"></i> Movimientos de Transporte
  </h1>
  <ol class="breadcrumb">
    <li><a href="?module=start"><i class="fa fa-home"></i> Inicio </a></li>
    <li><a href="?module=transporte_transaction"> Transporte </a></li>
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/transporte_transaction/proses.php?act=insert" method="POST" name="formObatMasuk">
            <div class="box-body">
              ...
              $codigo_transaccion = "K-$tahun-$buat_id";
              ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Total de Asignaciones</label>
                <div class="col-sm-5">
