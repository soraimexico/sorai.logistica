...
if (empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['Guardar'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO transaccion_venta(codigo_transaccion,fecha,codigo,numero,created_user,tipo_transaccion) 
            ...
            if ($query) {
                ...
                $query1 = mysqli_query($mysqli, "UPDATE venta SET stock        = '$total_stock'
                                                              WHERE codigo   = '$codigo'")
                                                or die('Error: '.mysqli_error($mysqli));
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=venta_transaction&alert=1");
                }
            }   
        }   
    }
