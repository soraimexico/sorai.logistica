...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <title>INFORME DE TRANSPORTISTA</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
           Informe de Transportista certificado
        </div>
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle"><small>UBICACION</small></th>
                        <th height="20" align="center" valign="middle"><small>PAQUETE</small></th>
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            echo "  <tr>
                        ...
                        <td style='padding-left:5px;' width='180' height='13' valign='middle'>$data[ubicacion]</td>
