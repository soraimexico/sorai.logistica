...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="?module=venta"> venta </a></li>
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" action="modules/venta/proses.php?act=insert" method="POST">
            <div class="box-body">
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(codigo,6) as codigo FROM venta
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select class="chosen-select" name="unidad" data-placeholder="-- Seleccionar --" autocomplete="off" required>
                    <option value=""></option>
                    <option value="Contenedor especial">contenedor especial</option>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT codigo,nombre,precio_venta,unidad FROM venta WHERE codigo='$_GET[id]'") 
                                      or die('error: '.mysqli_error($mysqli));
  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="modules/venta/proses.php?act=update" method="POST">
            <div class="box-body">
