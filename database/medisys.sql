...
CREATE TABLE `venta` (
  ...
  `precio_venta` int(11) NOT NULL,
  `unidad` varchar(20) NOT NULL,
  `quick` varchar(100) DEFAULT NULL,
  `created_user` int(3) NOT NULL,
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_user` int(3) NOT NULL,
  `updated_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
...
INSERT INTO `transaccion_venta` (`codigo_transaccion`, `fecha`, `codigo`, `numero`, `created_user`, `created_date`, `tipo_transaccion`) VALUES
('TM-2017-0000001', '2017-07-26', 'B000362', 5, 1, '2017-07-26 02:09:06', 'Entrada'),
('TM-2017-0000002', '2017-07-26', 'B000363', 10, 1, '2017-07-26 02:09:28', 'Entrada'),
('TM-2017-0000003', '2017-07-26', 'B000364', 5, 1, '2017-07-26 02:09:36', 'Salida');
-- --------------------------------------------------------
...
/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;
  ...
  `codigo_transporte` varchar(9) NOT NULL,
  ...
  ADD PRIMARY KEY (`codigo_transporte`),
  ADD KEY `created_user` (`created_user`),
  ADD KEY `updated_user` (`updated_user`);
